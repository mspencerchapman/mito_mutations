...
mutsites = array(data = NA, dim = c(16569 * 6,2))
mutsites[,1] <- rep(1:16569, times = 6)
mutsites[,2] <- rep(1:6, each = 16569)
...
write.table(mutations, "shearwater_normal_panel_rho_mu_calculation.tsv", sep = "\t", col.names = T, row.names = F, quote = F)
