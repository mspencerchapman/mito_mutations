...
for(i in seq(from = 0, to = 55, by = 5)){
...
write.table(test.matrix, file = paste0(substr(bam_file,1,nchar(bam_file) - 4),"_count_mq",i,".csv"),sep = ",",quote = F,row.names = F,col.names = T)
}
