...
```{r coverage_plot,fig.height=7.5,fig.width=10.5}
...
```{r median_coverage_plot,fig.height=4.5,fig.width=10.5}
...
```{r coverage_ridges,fig.height=4.5,fig.width=6}
...
```{r uniformity_ridges,fig.height=5.2,fig.width=6}
...
```{r mito_cn_pheno_summary_plot,fig.height=3.8,fig.width=5.2}
...
```{r mito_cn_by_sample_dot_plot,fig.height=3,fig.width=10.5}
...
```{r mito_cn_by_sample_dot_plot_by_phenotype,fig.height=3,fig.width=10.5}
...
```{r mtDNA_CN_phylogenetic_signal,fig.height=15,fig.width=9}
...
```{r mtDNA_CN_phylogenetic_signal_pvals,fig.height=3,fig.width=3.8}
...
```{r fig.height=3.3,fig.width=10.5}
...
```{r trinuc_plot_all,fig.height=6,fig.width=10.5}
...
```{r trinuc_plot_0.5-1,fig.height=6,fig.width=10.5}
trinucleotide_plot(mutations = df_tidy%>%
                     filter(Sample!="global"&
                              !mut_ref%in%exclude_muts&
                              vaf<0.01 & vaf>0.005)%>%
...
```{r trinuc_plot_sub0.5,fig.height=6,fig.width=10.5}
trinucleotide_plot(mutations = df_tidy%>%
                     filter(Sample!="global"&
                              !mut_ref%in%exclude_muts&
                              vaf<0.005)%>%
...
```{r mutburden_by_driverstatus,fig.height=3,fig.width=9}
...
```{r mutburden_by_clonestatus,fig.height=3,fig.width=9}
...
```{r consequence_change_plot,fig.height=4.5,fig.width=6}
...
```{r compare_misannotated_to_corrected1,fig.height=4.5,fig.width=4.5}
...
```{r compare_misannotated_to_corrected2,fig.height=4.5,fig.width=4.5}
...
```{r compare_misannotated_to_corrected3,fig.height=4.5,fig.width=4.5}
impact_comparison_df%>%
...
```{r compare_misannotated_to_corrected4,,fig.height=4.5,fig.width=4.5}
...
```{r mutations_by_type_violin,fig.height=4.5,fig.width=7.5}
...
```{r heteroplasmy_cum_distribution,fig.height=4.5,fig.width=4.5}
...
```{r mutation_type_by_gene,fig.height=3.8,fig.width=4.5}
...
```{r ju_VAF_distribution,fig.height=3.8,fig.width=3.8}
...
```{r ju_global_dnds,fig.height=3.8,fig.width=3}
...
```{r ju_dnds_by_gene_heatmap,fig.height=3.8,fig.width=3}
temp<-dndsout$sel_cv%>%
  dplyr::select(gene_name,wmis_cv,wnon_cv,qmis_cv,qtrunc_cv)
...
```{r ju_group_by_VAF,fig.height=3.8,fig.width=6}
...
```{r ju_dnds_by_vaf_by_gene,fig.height=3.8,fig.width=3.8}
