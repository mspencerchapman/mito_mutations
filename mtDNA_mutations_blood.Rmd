...
figures_dir=notebook_plots_dir("mtDNA_mutations_blood") #see save_plots in config.R
...
coverage.plot
save_plot(filename=paste0(figures_dir,"Coverage_plot.pdf"),coverage.plot,width=4,height=3)
```


```{r median_coverage_plot,fig.height=3,fig.width=7}
...
save_plot(filename=paste0(figures_dir,"Coverage_median_plot.pdf"),median.coverage.plot,width=7,height=2)
```
...
save_plot(filename=paste0(figures_dir,"median.coverage.ridges.plot.pdf"),median.coverage.ridges.plot,width=3.3,height=2.5)
```
...
```{r uniformity_ridges,fig.height=3.5,fig.width=4}
...
save_plot(filename=paste0(figures_dir,"Uniformity_perc80_ridges_plot.pdf"),uniformity_ridges.plot,width=3.3,height=2.5)
```
...
```{r mito_cn_pheno_summary_plot,fig.height=2.5,fig.width=3.5}
...
mito_cn_by_pheno
save_plot(filename=paste0(figures_dir,"mito_cn_by_pheno.pdf"),mito_cn_by_pheno,width=4,height=2)
```
...
save_plot(filename=paste0(figures_dir,"mito_cn_by_pheno_HSCprog.pdf"),mito_cn_by_pheno_all_HSCprog,width=4,height=2)
...
```{r mito_cn_by_sample_dot_plot,fig.height=2,fig.width=7}
...
save_plot(filename = paste0(figures_dir,"mtDNA.copy.number.logscale.pdf"),plot=mtDNA.copy.number.logscale,height=2,width=7)
```
...
```{r mito_cn_by_sample_dot_plot_by_phenotype,fig.height=2,fig.width=7}
...
save_plot(filename = paste0(figures_dir,"mtDNA.copy.number.logscale.by.phenotype.pdf"),plot=mtDNA.copy.number.logscale.by.phenotype,height=2,width=7)
```
...
save_plot(filename=paste0(figures_dir,"foetal_18pcw_by_cell_type_loc.pdf"),foetal_18pcw_by_cell_type_loc,width=3,height=2)
```
...
save_plot(filename = paste0(figures_dir,"median_mtDNA_CN_by_age.pdf"),plot = median_mtDNA_CN_by_age,width=3.5,height=2)
```
...
```{r mtDNA_CN_phylogenetic_signal_pvals,fig.height=2,fig.width=2.5}
...
save_plot(filename=paste0(figures_dir,"Sample_proportions_with_mut.pdf"),prop.of.samples.with.mut,width=3,height=2)
...
save_plot(filename=paste0(figures_dir,"mean_sum_of_vaf_by_age.pdf"),plot=mean_sum_of_vaf_by_age,height=2,width=3)
```
...
save_plot(filename = paste0(figures_dir,"sum_of_vaf_log.pdf"),plot=sum_of_vaf_plot_log,height=2,width=7)
```
...
save_plot(filename = paste0(figures_dir,"sum_of_vaf_log_by_celltype.pdf"),plot=sum_of_vaf_plot_log_by_celltype,height=2.2,width=7)
```
...
save_plot(filename = paste0(rebuttal_figs_dir,"sum_of_vaf_by_celltype_comparison.pdf"),plot=sum_of_vaf_by_celltype,height=2.2,width=7)
...
trinucleotide_plot(mutations = df_tidy%>%
                   ...
                   file_name = paste0(rebuttal_figs_dir,"Mutational_signature.pdf"))
```
...
trinucleotide_plot(mutations = df_tidy%>%
                   ...
                   analysis_region = "all_mtDNA",
                   analysis_type = "obs_exp",
                   file_name = paste0(rebuttal_figs_dir,"Mutational_signature_0.005_0.01.pdf"))
```
...
trinucleotide_plot(mutations = df_tidy%>%
                   ...
                   analysis_region = "all_mtDNA",
                   analysis_type = "obs_exp",
                   file_name = paste0(rebuttal_figs_dir,"Mutational_signature_<0.005.pdf"))
...
save_plot(filename = paste0(rebuttal_figs_dir,"sov_mut_vs_wt.pdf"),sov_mut_vs_wt,width=3.3,height=2.5)
```
...
save_plot(filename = paste0(rebuttal_figs_dir,"sov_exp_vs_singleton.pdf"),sov_exp_vs_singleton,width=3.3,height=2.5)
```
...
```{r consequence_change_plot,fig.height=3,fig.width=4}
...
save_plot(filename = paste0(rebuttal_figs_dir,"consequence_change_plot.pdf"),consequence_change_plot,width=3.5,height=2.5)
```


```{r compare_misannotated_to_corrected1,fig.height=3,fig.width=3}
...
```{r compare_misannotated_to_corrected2,fig.height=3,fig.width=3}
...
save_plot(filename = paste0(rebuttal_figs_dir,"total_numbers_old_vs_new_plot.pdf"),total_numbers_old_vs_new_plot,width=3,height=2.5)
```


```{r compare_misannotated_to_corrected3,fig.height=3,fig.width=3}
impact_comparison_df%>%
...
```{r compare_misannotated_to_corrected4,,fig.height=3,fig.width=3}
...
```{r mutations_by_type_violin,fig.height=3,fig.width=5}
...
```{r heteroplasmy_cum_distribution,fig.height=3,fig.width=3}
...
save_plot(filename = paste0(rebuttal_figs_dir,"mutation_type_ecdf_plot.pdf"),mutation_type_ecdf_plot,width=2.5,height=2.5)
```
...
save_plot(filename = paste0(rebuttal_figs_dir,"mutation_type_by_gene_blood.pdf"),mutation_type_by_gene,width=3.5,height=2.5)
...
save_plot(filename = paste0(rebuttal_figs_dir,"global_dnds_blood.pdf"),global_dnds_blood,width=1.3,height=2.5)
```
...
save_plot(filename = paste0(rebuttal_figs_dir,"dnds_heatmap_by_gene.pdf"),dnds_heatmap_by_gene,width=1.5,height=2.5)

```

### dndscv - split by heteroplasmy

```{r dnds_by_heteroplasmy}
...
save_plot(filename = paste0(rebuttal_figs_dir,"global_dnds_by_vaf_blood.pdf"),global_dnds_by_vaf_plot,width=1.6,height=2.5)
...
save_plot(filename = paste0(rebuttal_figs_dir,"global_dnds_bytype_by_vaf_plot.pdf"),global_dnds_bytype_by_vaf_plot,width=2.5,height=2.5)
...
save_plot(filename = paste0(rebuttal_figs_dir,"global_dnds_missense_by_vaf_plot.pdf"),global_dnds_missense_by_vaf_plot,width=1.6,height=2.5)
...
save_plot(filename = paste0(rebuttal_figs_dir,"dnds_heatmap_by_vaf_by_gene.pdf"),dnds_heatmap_by_vaf_by_gene,width=2.5,height=2.5)
...
```{r dnds_dichot_heteroplasmy_heatmap}
...
save_plot(filename = paste0(rebuttal_figs_dir,"dnds_heatmap_by_dichotomous_vaf_by_gene.pdf"),dnds_heatmap_by_dichotomous_vaf_by_gene,width=2.2,height=2.5)

```

## Re-analysis of Ju et al, cancer data

```{r ju_VAF_distribution,fig.height=2.5,fig.width=2.5}
...
ju_vaf_distribution
save_plot(filename = paste0(rebuttal_figs_dir,"ju_vaf_distribution.pdf"),ju_vaf_distribution,width=2,height=2.5)
```


```{r ju_global_dnds,fig.height=2.5,fig.width=2}
...
ju_global_dnds_plot<-dndsout$globaldnds%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.position="none")
ju_global_dnds_plot
save_plot(filename = paste0(rebuttal_figs_dir,"ju_global_dnds_plot.pdf"),ju_global_dnds_plot,width=2,height=2.5)
```


```{r ju_dnds_by_gene_heatmap,fig.height=2.5,fig.width=2}
temp<-dndsout$sel_cv%>%
  dplyr::select(gene_name,wmis_cv,wnon_cv,qmis_cv,qtrunc_cv)
...
save_plot(filename = paste0(rebuttal_figs_dir,"ju_dnds_by_gene_heatmap.pdf"),ju_dnds_by_gene_heatmap,width=2,height=2.5)
```

Analyse by heteroplasmy, as for the normal blood data

```{r ju_group_by_VAF,fig.height=2.5,fig.width=4}
...
save_plot(filename = paste0(rebuttal_figs_dir,"ju_global_dnds_missense_by_vaf_plot.pdf"),ju_global_dnds_missense_by_vaf_plot,width=4,height=2.5)
```


```{r ju_dnds_by_vaf_by_gene,fig.height=2.5,fig.width=2.5}
...
save_plot(filename = paste0(rebuttal_figs_dir,"ju_dnds_heatmap_by_vaf_by_gene.pdf"),ju_dnds_heatmap_by_vaf_by_gene,width=2.5,height=2.5)
