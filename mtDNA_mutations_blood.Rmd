...
ggsave(filename = paste0(rebuttal_figs_dir,"consequence_change_plot.pdf"),consequence_change_plot,width=3.5,height=2.5)
```
...
ggsave(filename = paste0(rebuttal_figs_dir,"total_numbers_old_vs_new_plot.pdf"),total_numbers_old_vs_new_plot,width=3,height=2.5)
```
...
ju_vaf_distribution
ggsave(filename = paste0(rebuttal_figs_dir,"ju_vaf_distribution.pdf"),ju_vaf_distribution,width=2,height=2.5)
```
...
ju_global_dnds_plot<-dndsout$globaldnds%>%
  ...
  theme(axis.title.x=element_blank(),
        ...
        legend.position="none")
ju_global_dnds_plot
ggsave(filename = paste0(rebuttal_figs_dir,"ju_global_dnds_plot.pdf"),ju_global_dnds_plot,width=2,height=2.5)
```
...
ggsave(filename = paste0(rebuttal_figs_dir,"ju_dnds_by_gene_heatmap.pdf"),ju_dnds_by_gene_heatmap,width=2,height=2.5)
```
...
ggsave(filename = paste0(rebuttal_figs_dir,"ju_global_dnds_missense_by_vaf_plot.pdf"),ju_global_dnds_missense_by_vaf_plot,width=4,height=2.5)
```
...
ggsave(filename = paste0(rebuttal_figs_dir,"ju_dnds_heatmap_by_vaf_by_gene.pdf"),ju_dnds_heatmap_by_vaf_by_gene,width=2.5,height=2.5)
