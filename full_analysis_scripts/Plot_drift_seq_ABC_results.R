...
#
# Outputs (one pair per ABC run, written alongside the ABC results):
...
exp_df<-data.frame(dirs=paste0(study_dir,
                               c("Drift_ABC_clonal_expansions/Drift_ABC_normal_individual/",
                                 "Drift_ABC_clonal_expansions/Drift_ABC_normal_sequential/",
                                 "Drift_ABC_clonal_expansions/Drift_ABC_MPN_individual/",
                                 "Drift_ABC_clonal_expansions/Drift_ABC_MPN_sequential/",
                                 "Drift_ABC_clonal_expansions/Drift_ABC_MPN_nocoding_individual/",
                                 "Drift_ABC_clonal_expansions/Drift_ABC_MPN_nocoding_sequential/",
                                 "Drift_ABC_clonal_expansions/Drift_ABC_CML_individual/",
                                 "Drift_ABC_clonal_expansions/Drift_ABC_CML_sequential/")),
...
#This cross-setting comparison IS panel e of Figure 6, and is generated by
#generate_figures/Generate_Fig6.R, which writes it to plots/Figure_06/. It is
#built here too so the comparison can be inspected while iterating on the ABC,
#but it is NOT saved, to avoid two scripts writing the same manuscript panel.
...
#Not saved - see the note above; Generate_Fig6.R writes this as Fig6e.
