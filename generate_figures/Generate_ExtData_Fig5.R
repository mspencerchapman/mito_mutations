...
#NOTE: this script shares its blood dN/dS analysis with Generate_Fig2.R, which is
#the authoritative source for the Figure 2 panels. The ggsave call below was a
#duplicate that silently overwrote them, and is disabled; the plot object itself
#is still built because the Extended Data Fig. 5 panels depend on the same analysis.
...
ggsave(filename = paste0(plots_dir,"Extended_Data_Figure_05/ExtDataFig5a.global_dnds_by_mut_status_plot.pdf"),global_dnds_by_mut_status_plot,width=3.5,height=2.5)
...
ggsave(filename = paste0(plots_dir,"Extended_Data_Figure_05/ExtDataFig5c.dnds_heatmap_by_mut_status_by_gene.pdf"),dnds_heatmap_by_mut_status_by_gene,width=2,height=3.5)
...
ggsave(filename = paste0(plots_dir,"Extended_Data_Figure_05/ExtDataFig5b.global_dnds_by_expansion_status_plot.pdf"),global_dnds_by_expansion_status_plot,width=3.5,height=2.5)
