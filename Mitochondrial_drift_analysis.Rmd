...
real_mut_distribution_plot+my_markdown_theme+theme(strip.text.x = element_text(size = 12),axis.text.x = element_text(size = 12,angle=90))
```
...
real_mut_distribution_plot_normalized+my_markdown_theme+theme(strip.text.x = element_text(size = 12),axis.text.x = element_text(size = 9,angle=90))
...
modelled_VAF_dist+my_markdown_theme+theme(strip.text.x = element_text(size = 12),axis.text.x = element_text(size = 9,angle=90))
...
real_syn_mut_distribution_plot_normalized+my_markdown_theme+theme(axis.text.x = element_text(size = 14,angle=90),strip.text.x = element_text(size = 12))
