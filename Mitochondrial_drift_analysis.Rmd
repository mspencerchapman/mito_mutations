...
real_mut_distribution_plot+my_markdown_theme+theme(strip.text.x = element_text(size=9),axis.text.x = element_text(size=6,angle=90))
```
...
real_mut_distribution_plot_normalized+my_markdown_theme+theme(strip.text.x = element_text(size=9),axis.text.x = element_text(size=6,angle=90))
...
modelled_VAF_dist+my_markdown_theme+theme(strip.text.x = element_text(size=9),axis.text.x = element_text(size=6,angle=90))
...
```{r fig.width=1.5,fig.height=3.8}
max_gen=1500
...
real_syn_mut_distribution_plot_normalized+my_markdown_theme+theme(axis.text.x = element_text(size=7,angle=90),strip.text.x = element_text(size=10))
...
```{r fig.width=3.8,fig.height=4.5}
