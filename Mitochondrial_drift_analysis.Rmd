...
ggsave(filename=paste0(figures_dir,"Figure_04/Modelled_VAF_dist.pdf"),modelled_VAF_dist,width = 6,height=2)
```
...
anim_save(filename=paste0(rebuttal_figs_dir,"driftwithage.gif"),animation = anim)
```
