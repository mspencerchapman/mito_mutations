...
real_mut_distribution_plot<-real_muts_dist_df%>%
  ...
  theme_bw()+
  my_markdown_theme+
  theme(axis.text.x = element_text(size = 10,angle=90),strip.text.x = element_text(size = 12))+
...
real_mut_distribution_plot+my_markdown_theme+theme(strip.text.x = element_text(size = 18),axis.text.x = element_text(size = 12,angle=90))
```
...
real_mut_distribution_plot_normalized+my_markdown_theme+theme(strip.text.x = element_text(size = 18),axis.text.x = element_text(size = 12,angle=90))
...
modelled_VAF_dist<-gens_record%>%
  ...
  theme_bw()+
  theme(legend.position = "none",axis.text.x = element_text(size = 10,angle=90),strip.text.x = element_text(size = 12))+
  scale_fill_manual(values = colorRampPalette(RColorBrewer::brewer.pal(8,"Spectral"))(1200))+
  labs(x="VAF group",y="Count")+
  my_markdown_theme

modelled_VAF_dist+my_markdown_theme+theme(strip.text.x = element_text(size = 18),axis.text.x = element_text(size = 12,angle=90))
...
drift_with_age_animation<-gens_record_summary%>%
  ...
  theme_bw()+
  my_markdown_theme+
  theme(title = element_text(size = 20),legend.position = "none",axis.text.x = element_text(angle=90,size=10),axis.title.x=element_text(size = 16),axis.title.y=element_text(size = 20))+
...
real_syn_mut_distribution_plot_normalized+my_markdown_theme+theme(axis.text.x = element_text(size = 14,angle=90),strip.text.x = element_text(size = 20))
