...
save_plot(filename=paste0(figures_dir,"Figure_04/real_mut_distribution_plot.pdf"),real_mut_distribution_plot_normalized,width=7,height=2.5)
```
...
save_plot(filename=paste0(figures_dir,"Figure_04/Modelled_VAF_dist.pdf"),modelled_VAF_dist,width = 6,height=2)
```
...
save_plot(filename = paste0(figures_dir,"Supp_Figure_04/Acquisition_time_by_VAF.pdf"),acquisition_time_by_VAF,width=7,height=2.5)
```
...
save_plot(filename = paste0(figures_dir,"Supp_Figure_04/acquisition_time_by_VAF_ridges.pdf"),acquisition_time_by_VAF_ridges,width=3.3,height=2.5)
```
...
save_plot(filename=paste0(figures_dir,"Figure_04/abc_res_plot_mut_rate.pdf"),abc_res_plot_mut_rate,width=1.75,height=2)
```
...
save_plot(filename=paste0(figures_dir,"Figure_04/abc_res_plot_total_generations.pdf"),abc_res_plot_total_generations,width=2,height=2)
```
...
save_plot(filename=paste0(figures_dir,"Figure_04/synonymous_noncoding_distribution_plot.pdf"),real_mut_distribution_plot_normalized,width=7,height=2.5)
```
...
save_plot(filename=paste0(figures_dir,"Figure_04/abc_synres_plot_mut_rate.pdf"),abc_synres_plot_mut_rate,width=1.75,height=2)
```
...
save_plot(filename=paste0(figures_dir,"Figure_04/abc_synres_plot_total_generations.pdf"),abc_synres_plot_total_generations,width=2,height=2)
```
