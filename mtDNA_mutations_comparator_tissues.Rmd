...
```{r mean_coverage,fig.width=10.5,fig.height=3.8}
name_conversion_vec=c("Normal blood","Lymphoid","MPN","Colon","IBD-affected\nColon","MUTYH-mutant\nColon","Endometrium","Bronchial\nepithelium")
names(name_conversion_vec)=c("blood","lymph","NW","HL","SO","PR","LM","KY")
tissue_cols<-c("#96e97c","#fd81c8","#145a6a","#65e6f9","#781486","#5f70cc","#aea2eb","#1d6d1f")
names(tissue_cols)<-name_conversion_vec
...
```{r median_coverage,fig.width=4.5,fig.height=3.8}
...
```{r uniformity,fig.width=4.5,fig.height=3.8}
...
```{r clonal_marking_plots,fig.width=4.5,fig.height=3.8}
dataset="CML"
...
```{r clonal_marking_plots2,fig.width=7.5,fig.height=3.8}
...
```{r copy_number_analysis_boxplot,fig.width=15,fig.height=6}
...
```{r copy_number_analysis_ridge_plot,fig.width=4.5,fig.height=3}
...
```{r copy_number_by_age,fig.width=4.5,fig.height=3}
...
```{r mean_cn_by_tissue_plot,fig.width=4.5,fig.height=3}
...
```{r mean_cn_regression_create_df,fig.width=4.5,fig.height=3}
...
```{r mean_cn_regression,fig.width=4.5,fig.height=3}
...
```{r model_comparison_AIC,fig.width=4.5,fig.height=3}
...
```{r model_smoking,fig.width=4.5,fig.height=3}
...
```{r lmer2_visualization_log,fig.width=4.5,fig.height=4.5}
...
```{r lmer2_visualization,fig.width=4.5,fig.height=3}
...
```{r trinuc_profiles1,fig.width=10.5,fig.height=6}
...
```{r trinuc_profiles2,fig.width=10.5,fig.height=6}
...
```{r mut_burden_stats,fig.width=4.5,fig.height=3}
mutCN_cutoff=25 #If the mitochondrial copy number is over 25, retain mutation even if is in the "CN correlating muts" list
vaf_cut_off<-0.03
rho_cut_off<-0
...
```{r prop_of_samples_with_mut,fig.width=10.5,fig.height=18}
...
```{r sum_of_vaf_data,fig.width=4.5,fig.height=3}
...
```{r sum_of_vaf_data_plots,fig.width=10.5,fig.height=21}
...
```{r mutation_rate_by_tissue_prep_data,fig.width=4.5,fig.height=3}
...
```{r mutation_rate_by_tissue_lmer,fig.width=4.5,fig.height=3}
...
```{r mutation_rate_by_tissue_lmer2,fig.width=4.5,fig.height=3}
...
```{r mutation_rate_by_tissue_and_age_lmer_plots,fig.width=4.5,fig.height=3.8}
...
```{r mutation_rate_by_tissue_and_age_lmer_plots2,fig.width=10.5,fig.height=3.8}
...
```{r nuclear_genetic_code,fig.width=4.5,fig.height=3,warning=FALSE,message=FALSE}
...
```{r consequence_change_plot,fig.width=4.5,fig.height=4.5}
...
```{r consequence_change_summary,fig.width=4.5,fig.height=3}
...
```{r consequence_change_plot2,fig.width=4.5,fig.height=3}
...
```{r consequence_change2,fig.width=4.5,fig.height=3,message=FALSE}
impact_comparison_df%>%
  filter(tissue!="blood")%>%
  dplyr::select(mut_ref,"new_annotation"=impact,"original_annotation"=impact_NUC)%>%
  tidyr::gather(-mut_ref,key="annotation",value="impact")%>%
...
```{r consequence_change3,fig.width=4.5,fig.height=3}
...
```{r mut_type_per_gene,fig.width=4.5,fig.height=3}
...
```{r mut_type_by_tissue,fig.width=4.5,fig.height=3}
...
```{r combine_epithelial_tissues,fig.width=4.5,fig.height=3,warning=F,message=F}
...
```{r ecdf_epithelial_tissues,fig.width=4.5,fig.height=3.8,warning=F,message=F}
...
```{r epithelial_tissues_dnds_dichot_vaf,fig.width=4.5,fig.height=3,warning=F,message=F}
...
```{r epithelial_tissues_dnds_by_vaf_and_gene,fig.width=4.5,fig.height=3}
...
```{r dnds_by_tissue,fig.width=4.5,fig.height=3,warning=F,message=F}
...
```{r gene_level_dnds_by_tissue,fig.width=7.5,fig.height=3.8}
qval_cutoff=0.05
...
```{r dnds_by_tissue_by_vaf,fig.width=4.5,fig.height=3}
...
```{r global_dnds_by_tissue_by_vaf2,fig.width=10.5,fig.height=3.8,warning=F,message=F}
...
```{r dnds_by_tissue_by_vaf_MPN_and_lymph_only,fig.width=4.5,fig.height=3}
max_dnds_value<-5
...
```{r dnds_by_tissue_by_vaf_nonblood_only,fig.width=4.5,fig.height=3}
max_dnds_value<-2.5
...
```{r gene_level_dnds_by_tissue_by_vaf,fig.width=6,fig.height=15}
gene_order=c(paste0("MT-ND",1:6),"MT-ND4L","MT-CYB",paste0("MT-CO",1:3),"MT-ATP6","MT-ATP8")
gene_order<-gene_order[gene_order%in%target_genes]
...
```{r split_into_groups,fig.width=15,fig.height=7.5}
## GROUP 1
...
```{r dnds_heatmap_by_tissue_and_vaf_by_gene_blood_and_lymph_only,fig.width=7.5,fig.height=7.5}
...
```{r dnds_by_dichotomous_vaf_by_tissue,fig.width=4.5,fig.height=4.5,warning=F,message=F}
...
```{r dnds_by_dichotomous_vaf_by_tissue_split,fig.width=7.5,fig.height=3.8}
max_dnds_value<-2.8
...
```{r gene_dnds_by_tissue_and_dichotomous_vaf,fig.width=6,fig.height=15}
gene_order=c(paste0("MT-ND",1:6),"MT-ND4L","MT-CYB",paste0("MT-CO",1:3),"MT-ATP6","MT-ATP8")
gene_order<-gene_order[gene_order%in%target_genes]
...
```{r MPN_selection_by_driver_WT,fig.width=4.5,fig.height=3,eval=F}
...
```{r MPN_selection_by_driver_WT2,fig.width=4.5,fig.height=3,eval=FALSE}
...
```{r heteroplasmic_oocyte_mutations,fig.width=4.5,fig.height=3}
...
```{r heteroplasmic_oocyte_mutations2,fig.width=4.5,fig.height=3,message=F,warning=F}
library(dndscv)
library(mitovizR)
...
```{r compare_heteroplasmic_oocyte_to_all_somatic,fig.width=4.5,fig.height=3}
...
```{r compare_heteroplasmic_oocyte_to_all_somatic2,fig.width=7.5,fig.height=7.5}
...
```{r inferring_clones_from_het_oocyte,fig.width=4.5,fig.height=3}
library(Seurat)
...
```{r inferring_clones_from_het_oocyte2,fig.width=15,fig.height=9}
